package ca.tweetzy.rose.files.comments.format;
...
import static ca.tweetzy.rose.files.comments.format.YamlCommentFormatterConfiguration.DEFAULT_COMMENT_PREFIX;
import static ca.tweetzy.rose.files.utils.StringUtils.BLANK_LINE;
