package ca.tweetzy.feather.files.comments.format;
...
import ca.tweetzy.feather.files.configuration.comments.format.CommentFormatter;
...
import static ca.tweetzy.feather.files.comments.format.YamlCommentFormatterConfiguration.DEFAULT_COMMENT_PREFIX;
import static ca.tweetzy.feather.files.utils.StringUtils.BLANK_LINE;
