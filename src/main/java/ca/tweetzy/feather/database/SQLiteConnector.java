package ca.tweetzy.feather.database;
...
public class SQLiteConnector implements DatabaseConnector {
    ...
    public SQLiteConnector(Plugin plugin) {
        this.plugin = plugin;
        this.connectionString = "jdbc:sqlite:" + plugin.getDataFolder() + File.separator + plugin.getDescription().getName().toLowerCase() + ".db?journal_mode=WAL";
