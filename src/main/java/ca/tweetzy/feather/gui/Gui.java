package ca.tweetzy.feather.gui;

import ca.tweetzy.feather.FeatherPlugin;
import ca.tweetzy.feather.comp.enums.CompMaterial;
import ca.tweetzy.feather.comp.enums.CompSound;
import ca.tweetzy.feather.comp.enums.ServerVersion;
import ca.tweetzy.feather.gui.events.*;
import ca.tweetzy.feather.gui.methods.*;
import ca.tweetzy.feather.utils.Common;
import ca.tweetzy.feather.utils.InventoryUpdate;
    ...
    public Gui setTitle(String title) {
        ...
        if (!title.equals(this.title)) {
            ...
            if (inventory != null) {
                ...
                toUpdate.forEach(viewer -> InventoryUpdate.updateInventory(FeatherPlugin.getInstance(), viewer, Common.colorize(finalTitle)));
            }
        }
